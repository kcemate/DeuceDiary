    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-xl border-t border-border">
      <div className="max-w-md mx-auto px-4">
        <div className="flex items-center justify-around py-3 pb-[env(safe-area-inset-bottom,8px)]">
          <Link href="/">
            <a className={cn(
              "nav-item flex flex-col items-center transition-colors rounded-xl px-5 py-2",
          ...
          <Link href="/groups">
            <a className={cn(
              ...
              <span className="text-[10px] font-bold">Squads</span>
            </a>
          </Link>
          ...
          <Link href="/bingo">
            <a className={cn(
              ...
              <span className="text-[10px] font-bold">Bingo</span>
            </a>
          </Link>
