      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-xl border-t border-border z-40">
        <div className="max-w-md mx-auto px-2">
          <div className="flex items-center justify-around py-2 pb-[env(safe-area-inset-bottom,8px)]">
            ...
            {/* FAB: Log a Deuce — the primary action, always accessible */}
            <button
              onClick={() => setShowLogModal(true)}
              className="relative -mt-7 flex flex-col items-center group"
              aria-label="Log a Deuce"
            >
              <div className="w-14 h-14 rounded-full bg-primary shadow-lg shadow-primary/30 flex items-center justify-center transition-all active:scale-90 group-hover:shadow-xl group-hover:shadow-primary/40">
