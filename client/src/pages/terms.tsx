      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-sm text-foreground/90 leading-relaxed">
          <section>
            ...
            <p>
              By using Deuce Diary ("the App"), you agree to these Terms of Service. If you
              don&apos;t agree, please close the app and find a less legendary way to track
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old to use Deuce Diary. By creating an account,
              you confirm you meet this age requirement. Potty training status is not a factor.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                Your username must not impersonate another person or contain slurs, hate speech,
                or personally identifiable information of others.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Keep it fun, keep it clean (well, as clean as a bathroom app can be).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You retain ownership of the content you post. By posting throne thoughts, you
              grant Deuce Diary a non-exclusive, royalty-free license to display that content to
              your group members within the App. We will not use your content for marketing or
              external purposes without your consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Deuce Diary is provided "as is." We do our best to keep the throne room open
              24/7, but we can&apos;t guarantee uninterrupted service. We are not liable for
              lost streaks due to server downtime, and we make no warranty — express or implied
              — regarding the reliability, accuracy, or completeness of the App.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, Deuce Diary and its creators shall not
              be liable for any indirect, incidental, special, or consequential damages arising
              from your use of the App. This includes, but is not limited to, lost data, lost
              streaks, bruised egos from leaderboard rankings, or any decisions made while
          ...
          <section>
            ...
            <p>
              ...
              for violations of these Terms. Upon termination, your data will be deleted within
              30 days.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              within the App. Continued use after changes means you accept the new Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              resolved in the courts of the state where the App&apos;s operators are based.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <strong>giovannilabs@icloud.com</strong>. We read every message — sometimes
