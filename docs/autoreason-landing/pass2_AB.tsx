      ...
      <section className="max-w-4xl mx-auto px-4 py-16 md:py-20" aria-label="Additional features">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
          {[
            ...
            { emoji: "🔔", label: "Streak Reminders" },
            { emoji: "🆘", label: "Streak Rescue" },
            { emoji: "💬", label: "Squad Chat" },
          ].map((item) => (
      ...
      <section className="max-w-2xl mx-auto px-4 py-16 md:py-20" aria-label="Frequently asked questions">
        ...
        <div className="space-y-3">
          {[
            ...
            {
              q: "Is it really free?",
              a: "The core experience — logging, streaks, squads, leaderboards — is 100% free. No paywalls, no tricks.",
            },
            {
...
1. **Hero copy** — Removed the `<br className="hidden md:block" />` from the subtitle. A single flowing paragraph is cleaner on all viewports and the line break added visual noise without earning its place.

2. **Demo feed** — Kept verbatim from Version X. The staggered IntersectionObserver reveal, skeleton loading, NEW badge pulse, and streak-rescue teaser at the bottom are the strongest conversion element on the entire page — they *show* the product instead of telling.

3. **Bonus features strip** — Replaced speculative items ("Porcelain Premium", "Invite & Referrals", "Mobile Native", "Lock screen widget") with features that actually map to what the demo feed and feature cards demonstrate: Streak Reminders, Streak Rescue, Squad Chat. This follows the "don't add features that don't exist" rule.

4. **FAQ** — Simplified the pricing answer from "Porcelain Premium adds power features…" to "No paywalls, no tricks." Vague upsell language for a tier that may not exist erodes trust; a direct "it's free" answer removes friction.

5. **Mobile app teaser** — Removed entirely. It promoted features that don't exist yet (iOS app, lock screen widgets, offline mode). Pre-announcing vaporware undermines the "prove it" energy the rest of the page builds. If the app ships later, add it back.

6. **Everything else** — Sticky mobile CTA, mid-page CTA, social proof stats, testimonials, footer, and accessibility attributes all carried over unchanged. They were already strong.