...
const testimonials = [
  {
    quote: "I've never been this regular in my life. My squad holds me accountable.",
    name: "Alex M.",
    streak: "47-day streak",
  },
  {
    quote: "The leaderboard turned my bathroom breaks into a competitive sport.",
    name: "Jordan K.",
    streak: "Top 10 weekly",
  },
  {
    quote: "Finally, an app that understands what matters. 10/10 would log again.",
    name: "Sam R.",
    streak: "93-day streak",
  },
];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white antialiased selection:bg-green-500/30">
      ...
      <section className="relative overflow-hidden pt-28 pb-16 sm:pt-40 sm:pb-24 px-4 sm:px-6">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div
            className="text-7xl sm:text-[5.5rem] leading-none mb-6 select-none animate-bounce"
      ...
      <section className="pb-20 sm:pb-28 px-4 sm:px-6">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-sm text-neutral-500 mt-2.5">Google, Apple, or email — pick your speed.</p>
        </div>
      </section>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-400">{t.streak}</p>
                  </div>
                </div>
              </div>
            ))}
