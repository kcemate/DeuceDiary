...
export function createKingRouter(): Router {
  ...
  router.get(
    ...
    isAuthenticated,
    requireGroupMember(),
    asyncRoute("Failed to fetch Deuce King", async (req, res) => {
  ...
  router.get(
    ...
    isAuthenticated,
    requireGroupMember(),
    asyncRoute("Failed to fetch challenge history", async (req, res) => {
      const groupId = req.groupId as string;
  ...
  router.get(
    ...
    isAuthenticated,
    requireGroupMember(),
    asyncRoute("Failed to fetch challenge", async (req, res) => {
      const groupId = req.groupId as string;
  ...
  router.post(
    ...
    isAuthenticated,
    requireGroupMember(),
    asyncRoute("Failed to set challenge", async (req, res) => {
      const groupId = req.groupId as string;
      const userId = req.user.id as string;
  ...
  router.post(
    ...
    isAuthenticated,
    requireGroupMember(),
    asyncRoute("Failed to mark challenge complete", async (req, res) => {
      const groupId = req.groupId as string;
      const userId = req.user.id as string;
